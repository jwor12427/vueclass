  ...
  <section id="cardType" class="card__wrap" :class="attr">
    ...
    <div class="card__inner" :class="layout">
      ...
      <article class="card">
        ...
        <div class="card__body">
          <h3 class="tit">까치(Oriental Magpie)</h3>
          <p class="desc">
      ...
      <article class="card">
        ...
        <div class="card__body">
          <h3 class="tit">비둘기(Rock dove)</h3>
          <p class="desc">
            전세계 대도시에서 흔하게 볼수 있는 비둘기는 수명이 10년~ 20년으로 꽤
            긴편에 속합니다. 주로 단체 생활을 하며 위협을 느낄 때는 특유의
